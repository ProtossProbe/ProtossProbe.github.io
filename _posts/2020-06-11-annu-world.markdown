---
layout: post
title:  "Annu 世界观设定 v1.0"
date:   2020-05-26 02:00:00 -0700
image:  /img/post-world/cover.jpg
tags:   [设定]
---

> 这是一个 Probe 已经构思了有好几年的架空世界观，原本打算用它来写一些小说或者故事之类的，但是因为仅有世界设定而没有人物设定就一直没有动笔。
...
1. 中心恒星「Kar'Phar 太阳」：一颗 K 型主序星，质量为太阳质量的 0.7 倍；

2. 行星「Demolix 煞星」：位于 Kar'Phar 系最内部的一颗类地行星，质量为地球质量的 0.1 倍，半长轴 0.08 天文单位。潮汐锁定，但因为距离恒星太近未有生命存在；

3. **行星「Annu 环/安努」：故事发生的星球。质量为地球质量的 1.5 倍，半径 1.1 倍，半长轴 0.52 天文单位。潮汐锁定且位于太阳的宜居带内，表面存在液态水、大气以及磁场；**

4. 行星「Glacierix 冰星」：第三颗类地行星。质量为地球质量的 0.9 倍，半径与地球半径相当，半长轴 1.33 天文单位。表面存在水与大气，但是因为距离太阳太过遥远常年冰冻，成为一颗冰封行星。生命是否存在未知；

5. 行星「Silveris 银神星」：一颗气态巨行星。质量为木星质量的 0.42 倍，半长轴 2.8 天文单位。

6. 行星「Vulcanoris 火神星」：一颗气态巨行星。质量为木星质量的 0.9 倍，半长轴 4.9 天文单位。

7. 行星「Voidris 無神星」：一颗冰巨行星。质量为海王星质量的 1.1 倍，半长轴 10.2 天文单位。

8. 未命名行星：一颗冰巨行星。质量为海王星质量的 0.6 倍，半长轴 58.6 天文单位。因为太过遥远尚未被环上的文明观测到。
...
9. 低魔世界，具有天赋的人可以通过系统化学习掌握元素类的简单法术，并且可以使用法术道具进行强度增幅。无死灵法术。
...
社会结构上看，舟介里是一个分封制的君主国家，皇城为「汀都（Ting）」。相比于奥达国国王的残酷与严苛，舟介里的天子却十分开明，因此受到很多舟介里人的爱戴。舟介里王国又下封了七个领主地，它们分别是：
...
>【井兰】商人、探险家、盗贼、建筑师、画家、吟游诗人、舞女、调酒师、酒馆老板、拍卖师；
